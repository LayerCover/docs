...
interface IPolicyManager {
    ...
    // clearIncreasesAndGetPendingAmount removed
    // getPendingIncreases removed
    ...
    function purchaseCoverageViaIntent(
        ...
        uint256 duration,
        bool requiresUpfront,
        bytes32 reservationKey,
        bytes32 referralCode
    ) external returns (uint256 policyId);

    function purchaseVaultCoverageViaIntent(
        address buyer,
        uint256 poolId,
        address vault,
    ...
    // addPremium removed - variable-rate policies are deprecated
