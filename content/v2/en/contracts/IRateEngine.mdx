...
The **IRateEngine** provides reference rate calculations and tracks market activity for analytics. In LayerCover's fixed-rate model, underwriters set their own rates when creating quotes—the RateEngine records these trades and provides reference data for dashboards and governance monitoring.
