...
Used by most pools. You can file a claim at any time, but in practice you'll want to wait until a **Risk Committee member reports the incident** - since claiming requires surrendering your tokens as salvage and paying a claim fee, it only makes economic sense once the covered event has actually occurred.

**Step-by-step:**

1. **Incident occurs** - The RiskManager reports the incident affecting your pool (this is your signal to act)
